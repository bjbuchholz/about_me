...
var answer3 = prompt('So no big american muscle for me, even though I would surely take a free Corvette if someone offered it. Do you think the favorite future car is Asian? ').toLowerCase();
console.log(answer3);
